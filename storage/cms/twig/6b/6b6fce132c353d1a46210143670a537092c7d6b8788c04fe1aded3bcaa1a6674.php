...
/* /Users/dickylam/Desktop/voltagehkc_localhost/themes/voltage/partials/footer.htm */
class __TwigTemplate_d47341112871f00945a2adbd2e5a6913b4a00ad33fbcc2ef510672417606075d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <script src=\"";
        // line 169
        echo $this->extensions['Cms\Twig\Extension']->themeFilter("assets/js/custom2.js");
        echo "\"></script>
  ...
  userFeed.run();
    ...
    ";
        // line 182
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, false, 182), "url", [], "any", false, false, false, 182) == "/")) {
            // line 183
            echo "    <!-- popup -->
    
    ";
            // line 185
            if (twig_get_attribute($this->env, $this->source, ($context["popup"] ?? null), "enable", [], "any", false, false, false, 185)) {
                // line 186
                echo "    
    ...
    <a class=\"fancybox\" href=\"#popjack\" id='popjackclick'>123</a>
        ...
        ";
                // line 199
                if (twig_get_attribute($this->env, $this->source, ($context["popup"] ?? null), "image", [], "any", false, false, false, 199)) {
                    // line 200
                    echo "        <div id='popjack'>
        <a href='";
                    // line 201
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["popup"] ?? null), "link", [], "any", false, false, false, 201), "html", null, true);
                    echo "' target='_blank'>
            <img src='";
                    // line 202
                    echo $this->extensions['Cms\Twig\Extension']->pageFilter("home");
                    echo "/storage/app/media/";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["popup"] ?? null), "image", [], "any", false, false, false, 202), "html", null, true);
                    echo "'>
        </a>
        </div>
        ";
    ...
    {
        return "/Users/dickylam/Desktop/voltagehkc_localhost/themes/voltage/partials/footer.htm";
    }
    ...
    {
        return array (  455 => 256,  450 => 253,  446 => 251,  427 => 235,  423 => 234,  393 => 206,  384 => 202,  380 => 201,  377 => 200,  375 => 199,  360 => 186,  358 => 185,  354 => 183,  352 => 182,  336 => 169,  332 => 168,  328 => 167,  322 => 164,  316 => 161,  310 => 158,  305 => 156,  301 => 155,  295 => 152,  287 => 147,  283 => 146,  277 => 143,  271 => 140,  267 => 139,  261 => 136,  255 => 133,  248 => 129,  244 => 128,  240 => 127,  236 => 126,  232 => 125,  228 => 124,  224 => 123,  220 => 122,  216 => 121,  212 => 120,  208 => 119,  202 => 116,  196 => 113,  192 => 112,  186 => 109,  180 => 106,  176 => 104,  165 => 103,  161 => 102,  95 => 39,  89 => 36,  83 => 33,  74 => 27,  68 => 24,  53 => 12,  49 => 11,  37 => 1,);
    }
...
<script src=\"https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.2.5/jquery.fancybox.min.js\">
    ...
    <script src=\"{{ 'assets/js/custom2.js'|theme }}\"></script>
...
</html>", "/Users/dickylam/Desktop/voltagehkc_localhost/themes/voltage/partials/footer.htm", "");
    }
}
